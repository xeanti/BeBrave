    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          ...
          phone: form.phone,
          moto_make: form.moto_make,
          moto_model: form.moto_model,
          moto_year: form.moto_year ? parseInt(form.moto_year) : null,
          moto_photo_url,
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-dark-900 text-white px-6 py-10">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Manage your personal information and motorcycle details.</p>
