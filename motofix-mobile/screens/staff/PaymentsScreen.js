...
export default function PaymentsScreen() {
  ...
  async function fetchPending() {
    ...
    // Filter only those with balance remaining
            ...
            return (
              <View key={b.id} style={s.card}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={s.cardSub}>{b.services?.name} · <Text style={s.dueText}>₱{due.toFixed(2)} due</Text></Text>
                  {totalPaid > 0 && (
                    <Text style={s.paidText}>₱{totalPaid.toFixed(2)} already paid</Text>
                  )}
                </View>
            ...
            return (
              <View key={o.id} style={s.card}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={s.cardSub}><Text style={s.dueText}>₱{due.toFixed(2)} due</Text></Text>
                  {totalPaid > 0 && (
                    <Text style={s.paidText}>₱{totalPaid.toFixed(2)} already paid</Text>
                  )}
                </View>
                <TouchableOpacity style={s.confirmBtn} onPress={() => openConfirm('order', o, due)}>
                  <Text style={s.confirmBtnText}>Confirm</Text>
                </TouchableOpacity>
              </View>
            );
